...
public class GossipScopeTest {
    ...
    public void testProperties() throws Exception {
        ...
        Map<String, String> lookedUpProperties = GossipScope.propertiesFrom(state,
                                                                            0);
    ...
    public void testSerialization() throws Exception {
        ...
        ServiceReferenceImpl deserialized = GossipScope.deserialize(registration,
                                                                    serialized);
    ...
    public void testMultipleRegistrations() throws Exception {
        ...
        scope.addServiceListener(listener,
                                 String.format("(%s=service:foo)",
                                               ServiceScope.SERVICE_TYPE));
        scope.addServiceListener(listener,
                                 String.format("(%s=service:bar)",
                                               ServiceScope.SERVICE_TYPE));
