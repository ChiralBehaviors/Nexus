 ...
 */
package com.hellblazer.nexus.gossip.fd;

import java.util.concurrent.locks.ReentrantLock;

import com.hellblazer.nexus.gossip.FailureDetector;
import com.hellblazer.nexus.util.RunningAverage;
import com.hellblazer.nexus.util.RunningMedian;
import com.hellblazer.nexus.util.SampledWindow;
...
public class PhiAccrualFailureDetector implements FailureDetector {
     ...
     * 
     * @see com.hellblazer.nexus.gossip.FailureDetector#shouldConvict(long)
     */
    @Override
